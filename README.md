...
Командой реализовали описанные [выше](#information) функции библиотеки:
...
- Оформили решение как статическую библиотеку с названием *s21_decimal.a* (с заголовочным файлом s21_decimal.h);
- Библиотека была разработана в соответствии с принципами структурного программирования;
- Подготовили полное покрытие unit-тестами функций библиотеки c помощью библиотеки Check;
- Покрытие Unit-тестами не менее 80% каждой функции;  
- Предусмотрели Makefile для сборки библиотеки и тестов (с целями all, clean, test, s21_decimal.a, gcov_report);
